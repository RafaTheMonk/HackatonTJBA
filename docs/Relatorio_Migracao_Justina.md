...
Pergunta esperada: Quais métricas indicarão que a migração está concluída com sucesso? Resposta sugerida: Throughput sustentado acima de 1.000 requisições por segundo, latência P95 abaixo de 200 milissegundos, erro menor që 0,1 por cento, cobertura de testes acima de 80 por cento e aprovação dos usuários piloto.
